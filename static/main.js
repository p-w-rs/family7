...
{
	if (region.a2.ap === region.bm.ap)
	{
		return 'on line ' + region.a2.ap;
	}
	return 'on lines ' + region.a2.ap + ' through ' + region.bm.ap;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dB, request.B, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {br: fragment, by: host, bR: path, bT: port_, bX: protocol, bY: query};
	});
							...
							return function (resume) {
								return function (error) {
									return function (stuff) {
										return {_: active_story, ad: email, z: error, bE: key, R: name, aq: other, ar: resName, as: resume, J: stuff, B: url};
									};
								};
							};
						};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			$author$project$Main$Model(key)(url)(0)('')('')('')('')($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.ah);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.a, offset) < 0,
					0,
					{bj: col, c: s0.c, e: s0.e, a: offset, b4: row, ah: s0.ah});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.a, s.b4, s.bj, s);
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.a, s1.a, s0.ah),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bj: col, c0: contextStack, bU: problem, b4: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.b4, s.bj, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.a, s.b4, s.bj, s.ah);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{bj: newCol, c: s.c, e: s.e, a: newOffset, b4: newRow, ah: s.ah});
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.a, s.b4, s.bj, s.ah);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bj: col, bU: problem, b4: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.b4, p.bj, p.bU);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bj: 1, c: _List_Nil, e: 1, a: 0, b4: 1, ah: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cA: false, be: r.be, c6: r.c6, bu: r.bu, dB: r.dB, ep: r.ep, ce: r.ce, B: r.B}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{be: r.be, c6: r.c6, bu: _List_Nil, dB: 'POST', ep: $elm$core$Maybe$Nothing, ce: $elm$core$Maybe$Nothing, B: r.B});
};
var $author$project$Main$upload = F4(
	function (file, name, email, other) {
		var url = (other === '') ? ('http://127.0.0.1:8000/new_resume' + ('/' + (name + ('/' + (email + ('/' + '!')))))) : ('http://127.0.0.1:8000/new_resume' + ('/' + (name + ('/' + (email + ('/' + other))))));
		return $elm$http$Http$post(
			{
				be: $elm$http$Http$fileBody(file),
				c6: $elm$http$Http$expectString($author$project$Main$Uploaded),
				B: url
			});
	});
			...
			case 7:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							ar: $elm$file$File$name(file),
							as: $elm$core$Maybe$Just(file)
						}),
					$elm$core$Platform$Cmd$none);
			case 8:
				var validForm = (!((model.R === '') || (model.ar === ''))) && $panthershark$email_parser$Email$isValid(model.ad);
				var _v2 = _Utils_Tuple2(validForm, model.as);
				if (_v2.a && (!_v2.b.$)) {
					var resume = _v2.b.a;
					return _Utils_Tuple2(
						model,
						A4($author$project$Main$upload, resume, model.R, model.ad, model.aq));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								z: $elm$core$Maybe$Just(true)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										z: $elm$core$Maybe$Just(true),
										J: $elm$core$Maybe$Just('network error')
									}),
								$elm$core$Platform$Cmd$none);
						case 3:
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										z: $elm$core$Maybe$Just(true),
										J: $elm$core$Maybe$Just('bad status')
									}),
								$elm$core$Platform$Cmd$none);
						default:
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										z: $elm$core$Maybe$Just(true),
										J: $elm$core$Maybe$Just('bad body')
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
...
var $author$project$Main$ResumeRequested = {$: 6};
...
var $author$project$Main$Upload = {$: 8};
...
var $mdgriffith$elm_ui$Internal$Model$asEl = 2;
var $mdgriffith$elm_ui$Internal$Style$classes = {cq: 'a', aR: 'atv', cs: 'ab', ct: 'cx', cu: 'cy', cv: 'acb', cw: 'accx', cx: 'accy', cy: 'acr', a8: 'al', a9: 'ar', cz: 'at', aS: 'ah', aT: 'av', cC: 's', cI: 'bh', cJ: 'b', cL: 'w7', cP: 'bd', cQ: 'bdt', az: 'bn', cR: 'bs', aA: 'cpe', cY: 'cp', cZ: 'cpx', c_: 'cpy', D: 'c', aC: 'ctr', aD: 'cb', aE: 'ccx', E: 'ccy', an: 'cl', aF: 'cr', c$: 'ct', c1: 'cptr', c2: 'ctxt', da: 'fcs', bq: 'focus-within', dc: 'fs', df: 'g', aV: 'hbh', aW: 'hc', bw: 'he', aX: 'hf', bx: 'hfp', di: 'hv', dl: 'ic', dn: 'fr', aH: 'lbl', dr: 'iml', ds: 'imlf', dt: 'imlp', du: 'implw', dv: 'it', dx: 'i', bH: 'lnk', af: 'nb', bK: 'notxt', dG: 'ol', dH: 'or', T: 'oq', dL: 'oh', bP: 'pg', bQ: 'p', dM: 'ppe', dP: 'ui', b4: 'r', dT: 'sb', dU: 'sbx', dV: 'sby', dW: 'sbt', dZ: 'e', d$: 'cap', d0: 'sev', d6: 'sk', aO: 't', eb: 'tc', ec: 'w8', ed: 'w2', ee: 'w9', ef: 'tj', aP: 'tja', eg: 'tl', eh: 'w3', ei: 'w5', ej: 'w4', ek: 'tr', el: 'w6', em: 'w1', en: 'tun', cg: 'ts', Y: 'clr', eu: 'u', a4: 'wc', cl: 'we', a5: 'wf', cm: 'wfp', a6: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.D);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.df);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bP);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bQ);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b4);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dZ);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.y)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.d1.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.d1.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.b4) + ('-' + ($elm$core$String$fromInt(pos.bj) + ('-' + ($elm$core$String$fromInt(pos.ck) + ('-' + $elm$core$String$fromInt(pos.bv)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.T)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.da, $mdgriffith$elm_ui$Internal$Style$classes.T)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.T)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b4) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b4) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aC) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aB: closing, k: _List_Nil, I: _List_Nil, w: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								k: A2(
									$elm$core$List$cons,
									{aB: '\n}', k: _List_Nil, I: props, w: '@supports (' + (prop + (':' + (value + (') {' + parent.w))))},
									rendered.k)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.w + ('{' + (renderValues(rule.I) + (rule.aB + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.b4) + (' / ' + ($elm$core$String$fromInt(position.b4 + position.bv) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.bj) + (' / ' + ($elm$core$String$fromInt(position.bj + position.ck) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.b4) + ('-' + ($elm$core$String$fromInt(position.bj) + ('-' + ($elm$core$String$fromInt(position.ck) + ('-' + $elm$core$String$fromInt(position.bv)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bv: height / size, d_: size, ci: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cV, adjustment.cH, adjustment.c3, adjustment.dz]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dZ))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.cy])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.cw])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.cx])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.cv])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aW)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aX)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.af, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.cq]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.af, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.cJ]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.af, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.dH]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.af, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.dG]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.af, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.dn]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.af, $mdgriffith$elm_ui$Internal$Style$classes.dZ, $mdgriffith$elm_ui$Internal$Style$classes.cI]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a8);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a9);
		default:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aT + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cz);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aT + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cs);
		default:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cC + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.b4 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dW + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bK)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.c$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.an)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$darkGrey = A4($mdgriffith$elm_ui$Element$rgba, 81 / 255, 81 / 255, 77 / 255, 0.1);
var $author$project$Main$darkerGrey = A4($mdgriffith$elm_ui$Element$rgba, 81 / 255, 81 / 255, 77 / 255, 1.0);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {bf: -box.bf, bF: -box.bF, b3: -box.b3, cd: -box.cd};
};
			...
			case 7:
				...
				return $mdgriffith$elm_ui$Element$Input$isFill(width) ? _Utils_update(
					els,
					{
						...
						dq: A2($elm$core$List$cons, attr, els.dq),
						b: A2($elm$core$List$cons, attr, els.b)
							...
							return _Utils_update(
								els,
								{
									...
									dq: A2(
										$elm$core$List$cons,
										newHeight,
										A2($elm$core$List$cons, newLineHeight, els.dq)),
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			return {
				...
				dq: $elm$core$List$reverse(redist.dq),
			...
			A3(
				...
				{o: _List_Nil, f: _List_Nil, dq: _List_Nil, b: _List_Nil, ak: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bK + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dM)),
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.o, textOptions.aO === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$email = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		...
		x: false,
		m: $mdgriffith$elm_ui$Element$Input$TextInputNode('email')
	});
...
var $author$project$Main$hide = function (n) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{s: $elm$core$Maybe$Nothing, x: multi.d2, m: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{t: multi.t, aK: multi.aK, aL: multi.aL, aO: multi.aO});
	});
...
var $author$project$Main$lightGreen = A4($mdgriffith$elm_ui$Element$rgba, 90 / 255, 196 / 255, 136 / 255, 1.0);
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.el);
...
var $mdgriffith$elm_ui$Element$spaceEvenly = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$spacing, $mdgriffith$elm_ui$Internal$Style$classes.d0);
var $mdgriffith$elm_ui$Element$Font$alignLeft = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.eg);
var $author$project$Main$red = A4($mdgriffith$elm_ui$Element$rgba, 255 / 255, 87 / 255, 51 / 255, 1.0);
			...
			return A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$moveLeft(15),
						$mdgriffith$elm_ui$Element$padding(10),
						$mdgriffith$elm_ui$Element$Font$color($author$project$Main$lightGreen)
					]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Join our team of committed teachers, and help save our families')
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Background$color($author$project$Main$darkGrey),
								$mdgriffith$elm_ui$Element$Border$width(5),
								$mdgriffith$elm_ui$Element$Border$rounded(10),
								$mdgriffith$elm_ui$Element$Border$color($author$project$Main$darkerGrey)
							]),
						_List_fromArray(
							[
								A4($author$project$Main$input_form, $author$project$Main$SetName, model.R, 'Enter your name...', 'Name (Required)'),
								A4($author$project$Main$email_form, $author$project$Main$SetEmail, model.ad, 'Enter your email...', 'Email (Required)'),
								...
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$Border$color($author$project$Main$lightGreen),
									...
									[
										...
										_List_fromArray(
											[
												...
												A2($author$project$Main$selectedFile, model.ar, model.as))
											]),
										{
											t: $mdgriffith$elm_ui$Element$text('Upload Resume'),
											bM: $elm$core$Maybe$Just($author$project$Main$ResumeRequested)
										}),
										A2(
										$mdgriffith$elm_ui$Element$Input$button,
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$Border$color($author$project$Main$darkerGrey),
												$mdgriffith$elm_ui$Element$below(
												$author$project$Main$submitMessage(model.z))
											]),
										{
											t: $mdgriffith$elm_ui$Element$text('Submit Form'),
											bM: $elm$core$Maybe$Just($author$project$Main$Upload)
										})
									])),
								$author$project$Main$hide(0)
							]))
					]))
			]));
};
...
var $author$project$Main$darkGreen = A4($mdgriffith$elm_ui$Element$rgba, 51 / 255, 85 / 255, 79 / 255, 1.0);
var $mdgriffith$elm_ui$Element$Font$heavy = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.ee);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$darkGreen)
			]),
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bH)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $author$project$Main$flink = F2(
	function (str, ln) {
		return A2(
			...
			{
				t: $mdgriffith$elm_ui$Element$text(str),
				B: ln
			});
	});
		...
		[
				...
				]),
			{
				t: A2(
					...
					{ab: 'Family 7 Logo and Link', ah: '/assets/f7_logo.png'}),
				B: '/home'
			}),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					...
					A2($author$project$Main$flink, 'Press Inquiries', 'mailto:press@family7foundations.com'),
					A2($author$project$Main$flink, 'Get Family7 in Your State', 'mailto:expand@family7foundations.com')
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
...
var $author$project$Main$lorem25 = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ut molestie risus, eu lacinia justo. Nunc elit nunc, pellentesque quis vestibulum vel, volutpat nec elit.';
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text($author$project$Main$lorem25),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Border$color($author$project$Main$darkGreen),
							$mdgriffith$elm_ui$Element$Border$rounded(15)
						]),
					{ab: 'A picture of a happy family', ah: '/assets/family1.jpg'})
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{da: $elm$core$Maybe$Nothing, di: $elm$core$Maybe$Nothing, dC: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dP, $mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dZ]))),
...
var $author$project$Main$green = A4($mdgriffith$elm_ui$Element$rgba, 86 / 255, 188 / 255, 130 / 255, 1.0);
var $mdgriffith$elm_ui$Element$Font$light = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.eh);
var $author$project$Main$msBullet = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Main$msFront = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('At Family 7 we '),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					$mdgriffith$elm_ui$Element$text('reunite')),
					$mdgriffith$elm_ui$Element$text(', '),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
					...
					$mdgriffith$elm_ui$Element$text('maintain')),
					...
					$mdgriffith$elm_ui$Element$text(' one family at a time')
				])),
			$author$project$Main$hide(0),
			$author$project$Main$hide(0),
			$author$project$Main$msBullet,
			$author$project$Main$msBullet,
			$author$project$Main$msBullet,
			$author$project$Main$msBullet,
			$author$project$Main$msBullet,
...
var $author$project$Main$mission = A2(
	$mdgriffith$elm_ui$Element$image,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$inFront($author$project$Main$msFront)
		]),
	{ab: 'A watercolor painting background', ah: '/assets/wtrm1.jpg'});
var $mdgriffith$elm_ui$Internal$Model$Right = 2;
var $mdgriffith$elm_ui$Element$alignRight = $mdgriffith$elm_ui$Internal$Model$AlignX(2);
var $author$project$Main$inv = A4($mdgriffith$elm_ui$Element$rgba, 0.0, 0.0, 0.0, 0.0);
...
var $author$project$Main$navlink = F2(
	function (name, path) {
		var color = _Utils_eq(
			$elm$core$String$toLower(name),
			path) ? $author$project$Main$lightGreen : $author$project$Main$inv;
		return A2(
			$mdgriffith$elm_ui$Element$link,
			_List_fromArray(
				[
			...
			{
				t: $mdgriffith$elm_ui$Element$text(name),
				B: '/' + $elm$core$String$toLower(name)
			});
	});
var $author$project$Main$navbar = function (path) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Main$navlink, 'Mission', path),
				A2($author$project$Main$navlink, 'Stories', path),
				A2($author$project$Main$navlink, 'Careers', path)
			]));
};
var $author$project$Main$offWhite = A4($mdgriffith$elm_ui$Element$rgba, 233 / 255, 233 / 255, 228 / 255, 0.5);
...
var $author$project$Main$greenLine = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerX,
...
var $author$project$Main$storyDot = F2(
	function (idx, activeIdx) {
		var color = _Utils_eq(idx, activeIdx) ? $author$project$Main$lightGreen : $author$project$Main$darkerGrey;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
...
var $author$project$Main$lorem = function (n) {
	return A3(
		$elm$core$List$foldr,
		$elm$core$Basics$append,
		'',
		A2($elm$core$List$repeat, n, $author$project$Main$lorem25));
};
var $author$project$Main$story_cont = $elm$core$Array$fromList(
	_List_fromArray(
		[
			$author$project$Main$lorem(16),
			$author$project$Main$lorem(14),
			$author$project$Main$lorem(12),
			$author$project$Main$lorem(18)
		]));
var $author$project$Main$story_imgs = $elm$core$Array$fromList(
	_List_fromArray(
		['/assets/family_st1.jpeg', '/assets/family_st2.jpeg', '/assets/family_st3.jpg', '/assets/family_st4.jpg']));
var $author$project$Main$story_titles = $elm$core$Array$fromList(
	_List_fromArray(
		['Family ABC', 'Family DEF', 'Family GHI', 'Family JKL']));
var $author$project$Main$stories = function (model) {
	var title = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Array$get, model._, $author$project$Main$story_titles));
	var src = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Array$get, model._, $author$project$Main$story_imgs));
	var content = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Array$get, model._, $author$project$Main$story_cont));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$below(
						$author$project$Main$storyDots(model._))
					]),
				{ab: 'A picture of a family', ah: src}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Font$size(60),
						$mdgriffith$elm_ui$Element$Font$semiBold,
						$mdgriffith$elm_ui$Element$below($author$project$Main$greenLine)
					]),
...
var $author$project$Main$view = function (model) {
	var page = function () {
		...
		switch (_v0) {
			...
			case '/mission':
				return $author$project$Main$mission;
			case '/stories':
			...
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$Background$color($author$project$Main$offWhite)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text(
								A2($elm$core$Maybe$withDefault, 'nothing', model.J))),
							$author$project$Main$navbar(
							A2($elm$core$String$dropLeft, 1, model.B.bR)),
							page,
							$author$project$Main$footer
						])))
			]),
		eq: 'Family 7 Foundations'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{dp: $author$project$Main$init, dI: $author$project$Main$UrlChanged, dJ: $author$project$Main$LinkClicked, ea: $author$project$Main$subscriptions, ev: $author$project$Main$update, ew: $author$project$Main$view});
